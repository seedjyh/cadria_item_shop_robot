...
class Grid:
    """
    There're always a list of grid in an area or scene.
    """
    ...
    def position(self, offset):
        ...
        :param offset: offset from left-top to the of center of this grid.
    ...
    def center(self):
        """
        get the position of center of this grid
        :return:
        """
        pass
