...
class AdventureChooseHero(Scene):
    def __init__(self, window):
        Scene.__init__(self, window)
        self._append_rule(1220, 493, "98DFFF")
        self._append_rule(1220, 495, "161E23")
        self._append_rule(1220, 695, "5A7FA5")
        self._append_rule(1220, 696, "A5D3F7")
        self._append_rule(387, 82, "65A6D8")
        self._slots = [
            Slot(Position(307, 492)),
            Slot(Position(475, 492)),
            Slot(Position(643, 492)),
            Slot(Position(811, 492)),
        ]

    def banner_is_hidden(self):
        rules = [
            MatchRule(Position(1206, 107), "2B5596")
        ]
